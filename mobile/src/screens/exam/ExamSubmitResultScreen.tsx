...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: "900", marginBottom: 10, color: theme.colors.text, textAlign: "center" },
  line: { fontSize: 16, marginBottom: 6, color: theme.colors.text, textAlign: "center" },
});